...
x_values_continous <- c('case.penalty_amount0_start',
			 'case.amount_applied0_start',
			 'case.penalty_amount1_start',
			  'case.amount_applied1_start',
			 'case.penalty_amount2_start',
			  'case.amount_applied2_start', 'case.penalty_amount3_start', 'case.payment_actual3_start', 'case.amount_applied3_start',
			 'case.penalty_amount0_complete',
			 'case.amount_applied0_complete',
			 'case.penalty_amount1_complete',
			 'case.amount_applied1_complete', 'case.penalty_amount2_complete',
			  'case.amount_applied2_complete', 'case.penalty_amount3_complete',
			 'case.amount_applied3_complete',
			'seconds_in_day')
