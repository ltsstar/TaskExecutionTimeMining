...
file_location <- '../../../src/notebooks/transformed_event_logs/BPIC_2017_waiting_time.csv'

x_values_categorical <- c('org.resource_schedule', 'concept.name',
...
x_values_continous <- c(#'case.RequestedAmount_schedule',
			'seconds_in_day')
