...
class StochasticLSTMCell(nn.Module):
    ...
    def regularizer(self):
        ...
        # Sum of squared weights for all weight parameters
        weight_sum = sum(torch.sum(params ** 2) for name, params in self.named_parameters() if name.endswith("weight"))
        weight_sum = weight_sum / (1. - p)
        
        # Sum of squared biases for all bias parameters
